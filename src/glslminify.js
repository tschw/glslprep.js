 ...
 */
goog.provide('glslminify');

/** @define {boolean} */
goog.define('glslminify.EXPORT_API', false);
...
goog.scope(function() {
	...
	if (glslminify.EXPORT_API) {

		goog.exportSymbol('glslminify.SyntaxError', $module.SyntaxError);

		goog.exportSymbol('glslminify.Shader', $module.Shader);
		...
		goog.exportSymbol('glslminify.parseGlsl', $module.parseGlsl);

		goog.exportSymbol('glslminify.minifyGlsl', $module.minifyGlsl);
